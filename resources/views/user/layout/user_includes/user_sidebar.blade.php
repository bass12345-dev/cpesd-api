<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">PESO DTS</span>
        </a>
              ...
              <i class="align-middle" data-feather="user"></i> <span class="align-middle">My Documents</span>
            </a>
					</li>
              ...
              <i class="align-middle" data-feather="book"></i> <span class="align-middle">Forwarded</span>
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="pages-blank.html">
              <i class="align-middle" data-feather="book"></i> <span class="align-middle">Track Documents</span>
            </a>
					</li>
